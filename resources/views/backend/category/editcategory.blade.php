                                ...
                                <div class="col-md-5">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="name" id=""
                                            placeholder="Tên danh mục mới" value="Áo khoác nữ">
                                        @if ($errors->has('name'))
                                ...
                                <div class="vertical-menu">
                                    ...
                                    <div class="item-menu"><span>Nam</span>
                                        <div class="category-fix">
                                            ...
                                            <a class="btn-category btn-danger" href="#"><i class="fas fa-times"></i></a>
                                        </div>
                                    </div>
                                    <div class="item-menu"><span>---|Áo khoác Nam</span>
                                        <div class="category-fix">
                                            <a class="btn-category btn-primary" href="{{ route('category.edit') }}"><i
                                                    class="fa fa-edit"></i></a>
                                            <a class="btn-category btn-danger" href="{{ route('category.edit') }}"><i
